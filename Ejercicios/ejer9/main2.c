//    COPYRIGHT (C) 2013 Tim O'Neil. All rights reserved.
//    Semaphore solution to unisex bathroom problem.
//    Based on code by Joe Lang, Univ. of Dayton.

//    Tim O'Neil, v. 1.03, 3.6.2013.
...
int main(){
    pthread_t t[5];
    //    Scenario 1: woman starts
    int arg[5] = { 3, 0, 1, 4, 2 };
    //    Scenario 2: man starts
    //int arg[5] = { 0, 1, 3, 2, 4 };
    ...
    for (int i = 0; i < 5; i++)
        pthread_create(&t[i], NULL, runnable, (void*)&arg[i]);
